        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Ilmu Politik' => 'Kepala Program Studi Ilmu Politik',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Ilmu Politik') 
                ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Ilmu Politik')
                ->columnSpanFull(),
            ]);
    }
