...
<html class="no-js" lang="en">
    ...
    <body class="loading" data-mobile-nav-style="classic" class="custom-cursor">
        <div id="preloader" class="tw-fixed tw-inset-0 tw-bg-white tw-z-50 tw-flex tw-items-center tw-justify-center">
            <svg class="tw-w-12 tw-h-12 tw-text-[#c7a469] tw-animate-spin" viewBox="0 0 64 64" fill="none"
            ...
            stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" class="tw-text-[#b98e44]">
            </path>
            </svg>
        </div>
        <main>
